...
from missions.models import MissionComplete
...
class Review(models.Model):
    ...
    # 미션 완료 후 작성 가능하게 연결
    mission_complete = models.ForeignKey(MissionComplete, on_delete=models.SET_NULL, null=True, blank=True, related_name='review')
